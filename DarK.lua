...
print([[
 ...
 .----------------.  .----------------.  .----------------.  .----------------.   
| .--------------. || .--------------. || .--------------. || .--------------. |  
| |  ________    | || |      __      | || |  _______     | || |  ___  ____   | |  
| | |_   ___ `.  | || |     /  \     | || | |_   __ \    | || | |_  ||_  _|  | |  
| |   | |   `. \ | || |    / /\ \    | || |   | |__) |   | || |   | |_/ /    | |  
| |   | |    | | | || |   / ____ \   | || |   |  __ /    | || |   |  __'.    | |  
| |  _| |___.' / | || | _/ /    \ \_ | || |  _| |  \ \_  | || |  _| |  \ \_  | |  
| | |________.'  | || ||____|  |____|| || | |____| |___| | || | |____||____| | |  
| |              | || |              | || |              | || |              | |  
| '--------------' || '--------------' || '--------------' || '--------------' |  
 '----------------'  '----------------'  '----------------'  '----------------'   
...
io.popen("mkdir -p DarK_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls DarK_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."DarK:Sudo:User", msg.sender_user_id_) 
...
local hash = database:sismember(bot_id.."DarK:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
...
local hash = database:sismember(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevDarK(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."DarK:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevDarK(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."DarK:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevDarK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."DarK:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevDarK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."DarK:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevDarK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."DarK:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."DarK:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."DarK:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DarK:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DarK:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DarK:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if tonumber(user_id) == tonumber(713005720) then  
var = "مطور السورس"
elseif DevDarKe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DarK:Sudo:User", user_id) then
var = database:get(bot_id.."DarK:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."DarK:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."DarK:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."DarK:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."DarK:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."DarK:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."DarK:Manager"..chat_id, user_id) then
var = database:get(bot_id.."DarK:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."DarK:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."DarK:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."DarK:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."DarK:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."DarK:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."DarK:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."DarK:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."DarK:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."DarK:GBan:User",User_id) then
Var = true
else
Var = false
end
...
for DarK in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = DarK
end
...
database:sadd(bot_id..'DarK:Chek:Groups',idg) 
database:set(bot_id.."DarK:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'DarK:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."DarK:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."DarK:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."DarK:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."DarK:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."DarK:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function DarK_Files(msg)
for v in io.popen('ls DarK_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("DarK_Files/"..v)
if plugin.DarK and msg then
pre_msg = plugin.DarK(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function DarK_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'DarK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'DarK:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
function Function_DarK(arg, data)
msg = arg.msg
if data.id_ then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text},Function_DarK,{msg=msg})
...
if database:get(bot_id.."DarK:DarK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."DarK:DarK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."DarK:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'DarK:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'DarK:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'DarK:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'DarK:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."DarK:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."DarK:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DarK:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."DarK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."DarK:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."DarK:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DarK:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DarK:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DarK:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."DarK:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DarK:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."DarK:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."DarK:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."DarK:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."DarK:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."DarK:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."DarK:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."DarK:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."DarK:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."DarK:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."DarK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."DarK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DarK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء وضع الوصف") 
database:del(bot_id.."DarK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."DarK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DarK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء حفظ الترحيب") 
database:del(bot_id.."DarK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."DarK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."DarK:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"📮┇تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DarK:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"📥┇تم الغاء حفظ الرابط")       
database:del(bot_id.."DarK:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."DarK:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."DarK:DarK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه للخاص") 
database:del(bot_id.."DarK:DarK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'DarK:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."DarK:DarK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."DarK:DarK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."DarK:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."DarK:DarK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."DarK:DarK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."DarK:DarK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."DarK:DarK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."DarK:UsersBot")   
...
local DarK_Msg = database:get(bot_id.."DarK:Add:Filter:Rp2"..text..msg.chat_id_)   
if DarK_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..DarK_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."DarK:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."DarK:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."DarK:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."DarK:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "📥┇ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."DarK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."DarK:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇ارسل الامر الجديد")  
database:del(bot_id.."DarK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."DarK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."DarK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."DarK:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."DarK:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇تم حفظ الامر")  
database:del(bot_id.."DarK:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."DarK:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."DarK:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."DarK:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."DarK:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."DarK:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."DarK:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."DarK:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."DarK:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."DarK:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'DarK:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."DarK:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."DarK:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."DarK:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."DarK:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."DarK:lockpin"..msg.chat_id_)  
database:srem(bot_id.."DarK:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."DarK:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."DarK:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'DarK:'..lock..msg.chat_id_)    
end
...
local list = database:smembers(bot_id.."DarK:Sudo:User")
t = "\n⛔┇قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DarK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DarK:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."DarK:Constructor"..msg.chat_id_)
t = "\n⛔┇قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DarK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DarK:Manager"..msg.chat_id_)
t = "\n⛔┇قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DarK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DarK:Mod:User"..msg.chat_id_)
t = "\n⛔┇قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DarK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DarK:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."DarK:Muted:User"..msg.chat_id_)
t = "\n⛔┇قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DarK:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DarK:Ban:User"..msg.chat_id_)
...
database:sadd(bot_id.."DarK:GBan:User", result.sender_user_id_)
...
database:sadd(bot_id.."DarK:GBan:User", result.id_)
...
database:sadd(bot_id.."DarK:GBan:User", userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:GBan:User", result.sender_user_id_)
...
database:srem(bot_id.."DarK:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."DarK:GBan:User", userid)
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Sudo:User", result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Sudo:User", result.id_)
...
database:sadd(bot_id.."DarK:Sudo:User", userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Sudo:User", result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Sudo:User", result.id_)
...
database:srem(bot_id.."DarK:Sudo:User", userid)
...
local res = https.request('https://xdstor.ml/api/Dark.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Basic:Constructor23"..msg.chat_id_, result.id_)
...
if database:get(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:DarK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:DarK:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:DarK:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:DarK:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:DarK:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevDarK(msg) then
 
local list = database:smembers(bot_id.."botss:DarK:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:DarK:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:DarK:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:DarK:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:DarK:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevDarK(msg) then
...
if text == "اضف رد متعدد" and DevDarK(msg) then
 
database:set(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevDarK(msg) then
 
database:set(bot_id.."botss:DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DarK:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DarK:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DarK:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:DarK:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DarK:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DarK:Add:Rd:Sudo:Text2"..text)   
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Basic:Constructor23"..msg.chat_id_, result.id_)
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Constructor"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DarK, nil)
end
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","💢┇تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."DarK:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم تنزيله من المنشئين")  
end
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Manager"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:sadd(bot_id.."DarK:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Special:User"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."DarK:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local DarKrt = database:get(bot_id.."DarK:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if DarKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."DarK:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif DarKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif DarKrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."DarK:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif DarKrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif DarKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."DarK:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local DarKrt = database:get(bot_id.."DarK:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if DarKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."DarK:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif DarKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif DarKrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n🔰┇تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."DarK:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."DarK:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."DarK:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."DarK:Muted:User"..msg.chat_id_, userid)
...
function Function_DarK(extra, result, success)
database:srem(bot_id.."DarK:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_DarK(extra, result, success)
if result.id_ then
database:srem(bot_id.."DarK:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."DarK:Muted:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."DarK:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."DarK:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."DarK:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"💢┇انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"📫┇ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."DarK:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."DarK:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"??┇تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"📥┇ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."DarK:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."DarK:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."DarK:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."DarK:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"☑┇جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."DarK:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."DarK:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."DarK:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."DarK:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."DarK:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."DarK:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."DarK:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."DarK:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."DarK:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."DarK:Get:Welcome:Group"..msg.chat_id_) 
...
local list = database:smembers(bot_id.."DarK:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DarK:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DarK:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local DarK_Msg = database:get(bot_id.."DarK:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DarK_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"📫┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DarK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DarK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DarK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DarK:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DarK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DarK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DarK:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DarK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."DarK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "📫┇تم الغاء حفظ القوانين") 
database:del(bot_id.."DarK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."DarK:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."DarK:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."DarK:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."DarK:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."DarK:List:Cmd:Group:New"..msg.chat_id_.."")
t = "🔰┇قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."DarK:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."DarK:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"🔰┇تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."DarK:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"🔰┇الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."DarK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."DarK:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."DarK:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."DarK:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."DarK:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."DarK:Coomds"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"🔘┇تم مسح الصلاحيات")
end
if text and text:match("^اضف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^اضف صلاحيه (.*)$")
database:set(bot_id.."DarK:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."DarK:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."DarK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."DarK:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "☑┇تم مسح الصلاحيه ") 
end
if database:get(bot_id.."DarK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"☑┇تم الغاء الامر ") 
database:del(bot_id.."DarK:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."DarK:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."DarK:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."DarK:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المطور الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."DarK:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المنشئ الاساسي الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."DarK:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المنشئ الى » "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."DarK:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المدير الى » "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."DarK:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد الادمن الى » "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."DarK:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المميز الى » "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."DarK:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد العضو الى » "..Teext)
end


if text == ("مسح ردود المدير") and Owner(msg) then
local list = database:smembers(bot_id.."DarK:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."DarK:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."DarK:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."DarK:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."DarK:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق 🃏"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره 🎇"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 📁"
elseif database:get(bot_id.."DarK:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."DarK:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."DarK:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."DarK:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."DarK:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."DarK:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."DarK:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."DarK:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."DarK:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."DarK:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"📫┇ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."DarK:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."DarK:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."DarK:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."DarK:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."DarK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."DarK:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."DarK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."DarK:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."DarK:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."DarK:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'DarK:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."DarK:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."DarK:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."DarK:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."DarK:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."DarK:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."DarK:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."DarK:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."DarK:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'DarK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'DarK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."DarK:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
local list = database:smembers(bot_id.."DarK:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."DarK:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."DarK:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."DarK:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."DarK:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."DarK:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."DarK:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."DarK:Add:Rd:Sudo:File"..v)
database:del(bot_id.."DarK:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."DarK:List:Rd:Sudo")
end
...
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."DarK:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif database:get(bot_id.."DarK:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."DarK:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."DarK:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."DarK:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."DarK:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."DarK:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."DarK:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."DarK:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."DarK:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"📌┇تم حفظ الرد بنجاح")
return false  
end  
...
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevDarK(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."DarK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."DarK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."DarK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"📌┇تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'DarK:'..v..text)
end
database:del(bot_id.."DarK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."DarK:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."DarK:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'DarK:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."DarK:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."DarK:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."DarK:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."DarK:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."DarK:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."DarK:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."DarK:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."DarK:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."DarK:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."DarK:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."DarK:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."DarK:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."DarK:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."DarK:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."DarK:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."DarK:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."DarK:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."DarK:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."DarK:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."DarK:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."DarK:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."DarK:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."DarK:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
if not database:get(bot_id.."DarK:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."DarK:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."DarK:Kick:Me"..msg.chat_id_,true)  
Text = "\n📫┇تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_DarK(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."DarK:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."DarK:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."DarK:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_DarK(extra, result, success)
if database:sismember(bot_id.."DarK:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."DarK:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."DarK:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."DarK:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."DarK:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
database:sadd(bot_id.."DarK:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
Namebot = (database:get(bot_id.."DarK:Name:Bot") or "دارك")
ArrayRdods = {
"تراك ازعجتنا",
...
if DevDarK(msg) then
database:setex(bot_id.."DarK:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if text == "اضف رد عام" and DevDarK(msg) then 
database:set(bot_id.."DarK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
database:del(bot_id.."DarK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"📥┇  ارسل الكلمه التري تريد اضافتها للرد العام")
return false 
end

if text and DevDarK(msg) and database:get(bot_id.."DarK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
database:del(bot_id.."DarK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_)
database:set(bot_id.."DarK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_, '📥┇ الان ارسل الرد الذي تريد اضافته للعام \n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
return false
end

if text and DevDarK(msg) and database:get(bot_id.."DarK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
Klma = database:get(bot_id.."DarK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
Jwab = text
...
if text == "مسح رد عام" and DevDarK(msg) then 
database:set(bot_id.."DarK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"📥┇  ارسل الكلمه التي تريد مسحها للرد العام")
return false 
end


if text == "مسح الردود العامه" and DevDarK(msg) then 
...
if text == 'الردود العامه' and DevDarK(msg) then
...
if text == 'تعين الايدي عام' and DevDarK(msg) then
database:setex(bot_id.."DarK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
   ☑┇ ارسل الان النص
   ☑┇ يمكنك اضافه :
   - `#username` > اسم المستخدم
...
if text == 'حذف الايدي عام' or text == 'مسح الايدي عام' and DevDarK(msg) then
database:del(bot_id.."DarK:KleshIDALLBOT")
send(msg.chat_id_, msg.id_, '📌┇تم ازالة كليشة الايدي ')
return false  
end 

if database:get(bot_id.."DarK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_) then 
database:del(bot_id.."DarK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_) 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء تعين الايدي عام") 
return false  
end 
database:set(bot_id.."DarK:KleshIDALLBOT",text:match("(.*)"))
...
return false 
   ...
   function Function_DarK(extra, result, success)
      tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
         ...
         local Id = data.id_
         local Status_Gps = database:get(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
...
----==========================================================================================================
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."DarK:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"📫┇ تم مغادرة المجموعه") 
database:srem(bot_id.."DarK:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."DarK:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevDarK(msg) then   
database:del(bot_id.."DarK:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"📫┇تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevDarK(msg) then  
database:set(bot_id.."DarK:Left:Bot"..msg.chat_id_,true)   
...
if database:get(bot_id.."DarK:Status:Bc") and not DevDarK(msg) then 
send(msg.chat_id_, msg.id_,"📫┇الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."DarK:DarK:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."DarK:DarK:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."DarK:DarK:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."DarK:DarK:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."DarK:DarK:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥┇ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevDarK(msg) then  
database:del(bot_id.."DarK:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevDarK(msg) then  
database:set(bot_id.."DarK:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n📫┇تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."DarK:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."DarK:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."DarK:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."DarK:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."DarK:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."DarK:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."DarK:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."DarK:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."DarK:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."DarK:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."DarK:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."DarK:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n🔰┇ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n🔏┇علامة ال {✓} تعني مفعل"..
...
http.request('http://devstorm.ml/DarK/tahaj200.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
if text == 'تعين الايدي' and Owner(msg) then
database:setex(bot_id.."DarK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
☑┇ ارسل الان النص
☑┇ يمكنك اضافه :
- `#username` > اسم المستخدم
...
if Owner(msg) then
database:del(bot_id.."DarK:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '📌┇تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."DarK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء تعين الايدي") 
database:del(bot_id.."DarK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."DarK:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."DarK:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'📌┇تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'DarK:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'DarK:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."DarK:Spam:Group"..msg.sender_user_id_,text) 
...
local Status_Gps = database:get(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'DarK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."DarK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."DarK:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."DarK:KleshIDALLBOT")
if not database:get(bot_id..'DarK:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'DarK:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."DarK:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'DarK:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."DarK:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."DarK:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
local texte = '\n*▹ |ايديك  . '..Id..'\n▹ | معرفك  .* ['..UserName_User..']*\n▹ |رتبتك  . '..Status_Gps..'\n▹ | رسائلك  . '..NumMsg..' \n▹ | التفاعل . '..TotalMsg..'\n▹ |الالعاب  . '..Num_Games..'*'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'DarK:Lock:ID:Bot'..msg.chat_id_) then
...
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."DarK:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
database:set(bot_id.."DarK:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"🔰┇اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
if text == ""..(database:get(bot_id.."DarK:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."DarK:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."DarK:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ سمايل , سمايلات }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or tect == "ترتيب" then
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."DarK:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."DarK:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."DarK:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."DarK:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."DarK:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Speed:Tr"..msg.chat_id_,true)
end 

if text == "حزوره" then
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."DarK:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."DarK:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."DarK:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."DarK:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."DarK:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ حزوره }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Hzora"..msg.chat_id_,true)
end 

if text == "معاني" then
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."DarK:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."DarK:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."DarK:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."DarK:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."DarK:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ معاني }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Maany"..msg.chat_id_,true)
end 
if text == "العكس" then
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."DarK:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."DarK:Set:Aks:Game"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."DarK:Set:Aks:Game"..msg.chat_id_) or "").."" and not database:get(bot_id.."DarK:Set:Aks"..msg.chat_id_) then
if not database:get(bot_id.."DarK:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ العكس }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."DarK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"📬┇عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = database:get(bot_id.."DarK:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."DarK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."DarK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"🔖┇مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."DarK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."DarK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."DarK:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."DarK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."DarK:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n📛┇اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."💢┇ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."🔖┇سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
database:setex(bot_id.."DarK:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."DarK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"📬┇عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."DarK:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."DarK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"📮┇مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊┇لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."DarK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."DarK:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."DarK:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
database:del(bot_id.."DarK:Set:Moktlf:Bot"..msg.chat_id_)
database:set(bot_id.."DarK::Set:Moktlf"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."DarK::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."DarK:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."DarK::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ المختلف }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثله" then
if database:get(bot_id.."DarK:Lock:Games"..msg.chat_id_) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
name = mthal[math.random(#mthal)]
database:set(bot_id.."DarK:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."DarK:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."DarK:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."DarK:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."DarK:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ امثله }")
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."DarK:Set:Amth:Bot"..msg.chat_id_,true)
end
if text == "تعطيل الالعاب" and Owner(msg) then   
database:del(bot_id.."DarK:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n☑┇تم تعطيل الالعاب") 
end
if text == "تفعيل الالعاب" and Owner(msg) then  
database:set(bot_id.."DarK:Lock:Games"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"\n☑┇تم تفعيل الالعاب") 
end
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'DarK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '📨┇عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'DarK:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'DarK:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '✏┇عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'DarK:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."DarK:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '👥┇عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'DarK:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع جهاتك المضافه '
send(msg.chat_id_, msg.id_,Text) 
end

if text == "مجوهراتي" then 
local Num = database:get(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"🔖┇ليس لديك جواهر من الالعاب \n📬┇اذا كنت تريد ربح الجواهر \n📌┇ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n💢┇ليس لديك جواهر بهاذا العدد \n📬┇لزيادة مجوهراتك في اللعبه \n📌┇ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."DarK:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id.."DarK:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
if database:get(bot_id.."DarK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."DarK:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "📮┇تم الغاء الامر ") 
database:del(bot_id.."DarK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."DarK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."DarK:id:user"..msg.chat_id_)  
database:del(bot_id.."DarK:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
database:incrby(bot_id.."DarK:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑┇تم اضافة له {"..numadded.."} من الرسائل")  
end
if database:get(bot_id.."DarK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."DarK:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "☑┇تم الغاء الامر ") 
database:del(bot_id.."DarK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."DarK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."DarK:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑┇تم اضافة له {"..numadded.."} من المجوهرات")  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
taha = text:match("^اضف رسائل (%d+)$")
database:set(bot_id.."DarK:id:user"..msg.chat_id_,taha)  
database:setex(bot_id.."DarK:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."DarK:idgem:user"..msg.chat_id_,taha)  
database:setex(bot_id.."DarK:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."DarK:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
database:del(bot_id.."DarK:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
database:incrby(bot_id.."DarK:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
local pv = database:smembers(bot_id..'DarK:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'DarK:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = database:smembers(bot_id..'DarK:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'DarK:Chek:Groups',group[i])  
w = w + 1
end
...
download_to_file('https://raw.githubusercontent.com/DarKxTeaM/DarK/master/DarK.lua', 'DarK.lua') 
download_to_file('https://raw.githubusercontent.com/DarKxTeaM/DarK/master/start.lua', 'start.lua') 
dofile('DarK.lua')  
return false
end
...
database:set(bot_id..'DarK:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'👥┇ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'DarK:Chek:Groups')  
local Users = database:scard(bot_id..'DarK:UsersBot')  
...
for k,v in pairs(list) do   
NAME = 'DarK Chat'
ASAS = database:smembers(bot_id.."DarK:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."DarK:Constructor"..v)
MDER = database:smembers(bot_id.."DarK:Manager"..v)
MOD = database:smembers(bot_id.."DarK:Mod:User"..v)
link = database:get(bot_id.."DarK:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"DarK":"'..NAME..'",'
else
t = t..',"'..v..'":{"DarK":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'DarK:Text_Dev')
if Text_Dev then 
...
if DevDarK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DarKxTeaM/files_DarK/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات دارك \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n📌┇تدل علامة (✔) الملف مفعل\n".."📌┇تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("DarK_Files/"..name,"r")
...
local file_bot = io.open("DarK_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/DarKxTeaM/files_DarK/master/files_DarK/"..file)
if res == 200 then
os.execute("rm -fr DarK_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOBBB.lua')  
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/DarKxTeaM/files_DarK/master/files_DarK/"..file)
if res == 200 then
local chek = io.open("DarK_Files/"..file,'w+')
...
os.execute("rm -fr DarK_Files/*")
send(msg.chat_id_,msg.id_,"☑┇تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevDarK(msg) then
local Users = database:smembers('DarK:'..bot_id.."userss")
local Groups = database:smembers('DarK:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'DarK:Chek:Groups',Groups[i])  
local list1 = database:smembers('DarK:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."DarK:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('DarK:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."DarK:Constructor"..Groups[i], v)
end
local list3 = database:smembers('DarK:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."DarK:Manager"..Groups[i], v)
end
local list4 = database:smembers('DarK:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."DarK:Mod:User"..Groups[i], v)
end
database:set(bot_id.."DarK:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'DarK:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'DarK:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'👥┇تم نقل : '..#Groups..' كروب\n👤┇تم نقل : '..#Users..' مشترك \n🔘┇من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevDarK(msg) then
database:del(bot_id..'DarK:Text_Dev')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevDarK(msg) then
database:set(bot_id..'DarK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'DarK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'DarK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'🔖┇تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'DarK:Text_Dev',text)
database:del(bot_id..'DarK:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = username[2]}, Function_DarK, nil)
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'DarK:Num:Add:Bot') or 0) and not DevDarK(msg) then
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'DarK:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'DarK:Chek:Groups',msg.chat_id_) then
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'DarK:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
database:sadd(bot_id..'DarK:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
database:set(bot_id.."DarK:Private:Group:Link"..msg.chat_id_,LinkGp)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'DarK:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'DarK:Free:Add:Bots') then 
local res = https.request('https://xdstor.ml/api/Dark.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@bobbb] ⚜️')   
...
database:sadd(bot_id..'DarK:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'DarK:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'DarK:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevDarK(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
local NumMsg = database:get(bot_id..'DarK:messageUser'..data.chat_id_..':'..data.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."DarK:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'DarK:message_edit'..data.chat_id_..data.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."DarK:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."DarK:Add:Memp"..data.chat_id_..":"..data.sender_user_id_) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
...
local Id = users[2]
local NumMsg = database:get(bot_id..'DarK:messageUser'..data.chat_id_..':'..users[2]) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."DarK:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'DarK:message_edit'..data.chat_id_..users[2]) or 0
local Num_Games = database:get(bot_id.."DarK:Add:Num"..data.chat_id_..users[2]) or 0
local Add_Mem = database:get(bot_id.."DarK:Add:Memp"..data.chat_id_..":"..users[2]) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
...
database:del(bot_id.."DarK:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DarK:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'DarK:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'DarK:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DarK:Lock:Games"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DarK:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'DarK:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'DarK:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DarK:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Lock:Games"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DarK:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DarK:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
database:set(bot_id.."DarK:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."DarK:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DarK:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."DarK:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DarK:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:srem(bot_id..'DarK:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:del(bot_id..'DarK:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'DarK:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 
...
if text and DevDarK(msg) and database:get(bot_id.."DarK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
   database:del(bot_id.."DarK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_)
...
if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'DarK:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'DarK:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'DarK:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'DarK:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
...
local res = https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
   ...
   ---==========================================
   ---==========================================
database:set(bot_id.."DarK:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."DarK:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."DarK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."DarK:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."DarK:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."DarK:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."DarK:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."DarK:Name:Bot") or "دارك")
if not database:get(bot_id.."DarK:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
DarK_Started_Bot(msg,data)
DarK_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
if msg.reply_markup_ and msg.reply_markup_.rows_ then return false end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'DarK:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."DarK:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."DarK:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."DarK:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."DarK:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."DarK:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local DarK_Msg = database:get(bot_id.."DarK:Add:Filter:Rp2"..text..result.chat_id_)   
if DarK_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..DarK_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'DarK:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'DarK:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'DarK:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'DarK:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'DarK:Chek:Groups',v)  
end
...
database:sadd(bot_id..'DarK:Chek:Groups',v)  
end end,nil)
end;end;end
